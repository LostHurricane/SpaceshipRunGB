...
namespace Mechanics
{
    public class PlanetOrbit : NetworkMovableObject
    {
        ...
        protected override void FromServerUpdate()
        {
            ...
            transform.position =
            Vector3.SmoothDamp(transform.position, _serverPosition, ref _currentPositionSmoothVelocity, _speed);
        ...
        protected override void HasAuthorityMovement()
        {
            ...
            transform.rotation =
            Quaternion.AngleAxis(_currentRotationAngle, transform.up);
